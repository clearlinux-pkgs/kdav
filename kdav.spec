...
Version  : 5.105.0
Release  : 52
URL      : https://download.kde.org/stable/frameworks/5.105/kdav-5.105.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.105/kdav-5.105.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.105/kdav-5.105.0.tar.xz.sig
...
%prep
%setup -q -n kdav-5.105.0
cd %{_builddir}/kdav-5.105.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681750622
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5DAV.so.5.105.0
