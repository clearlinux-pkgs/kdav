...
Source0  : https://download.kde.org/stable/release-service/20.04.2/src/kdav-20.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.2/src/kdav-20.04.2.tar.xz.sig
...
%prep
%setup -q -n kdav-20.04.2
cd %{_builddir}/kdav-20.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591906472
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdav-20.04.2/COPYING %{buildroot}/usr/share/package-licenses/kdav/7e52b139aa82028afadf25f4b534d2404bf97cca
cp %{_builddir}/kdav-20.04.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/kdav/ba8966e2473a9969bdcab3dc82274c817cfd98a1
pushd clr-build
%make_install
popd
%find_lang libkdav
