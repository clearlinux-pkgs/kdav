...
Version  : 5.89.0
Release  : 35
URL      : https://download.kde.org/stable/frameworks/5.89/kdav-5.89.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.89/kdav-5.89.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.89/kdav-5.89.0.tar.xz.sig
...
%prep
%setup -q -n kdav-5.89.0
cd %{_builddir}/kdav-5.89.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639697973
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdav-5.89.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kdav/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kdav-5.89.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdav/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kdav-5.89.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdav/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
%find_lang libkdav
