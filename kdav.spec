...
Version  : 5.85.0
Release  : 31
URL      : https://download.kde.org/stable/frameworks/5.85/kdav-5.85.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.85/kdav-5.85.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.85/kdav-5.85.0.tar.xz.sig
...
%prep
%setup -q -n kdav-5.85.0
cd %{_builddir}/kdav-5.85.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630908145
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdav-5.85.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdav/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kdav-5.85.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdav/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
%find_lang libkdav
