...
Source0  : https://download.kde.org/stable/frameworks/6.11/kdav-6.11.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.11/kdav-6.11.0.tar.xz.sig
...
%setup -q -n kdav-6.11.0
cd %{_builddir}/kdav-6.11.0
pushd ..
cp -a kdav-6.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739578665
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6DAV.so.6.11.0
/usr/lib64/libKF6DAV.so.6
/usr/lib64/libKF6DAV.so.6.11.0
