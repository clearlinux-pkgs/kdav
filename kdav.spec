...
Source0  : https://download.kde.org/stable/frameworks/5.97/kdav-5.97.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.97/kdav-5.97.0.tar.xz.sig
...
%prep
%setup -q -n kdav-5.97.0
cd %{_builddir}/kdav-5.97.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660577470
mkdir -p clr-build
pushd clr-build
