...
Version  : 5.99.0
Release  : 45
URL      : https://download.kde.org/stable/frameworks/5.99/kdav-5.99.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.99/kdav-5.99.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.99/kdav-5.99.0.tar.xz.sig
...
%prep
%setup -q -n kdav-5.99.0
cd %{_builddir}/kdav-5.99.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665436978
mkdir -p clr-build
pushd clr-build
